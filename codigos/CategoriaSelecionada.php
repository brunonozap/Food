...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../css/categoria_selecionada.css" />
	...
	<body>
        ...
        <section class="food-menu">
            <div class="container">
                <h2 class="text-center"><?php echo $_GET['categoria']; ?></h2>
                <?php include('ExibicaoCategorias.php'); ?>        
                <div class="clearfix"></div>
            </div>
        </section>

        <div class="footer">
            <img class="imagem" src="../imagens/NozapBranco.png" alt="" style="width:15%;"/>
