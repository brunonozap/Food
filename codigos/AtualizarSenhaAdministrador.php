...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" href="../css/atualizarsenhaadm.css" />
            ...
            <div id="add-restaurante-Fundo"> 
                ...
                <div class="formulario-geral">
                    ...
                    <form id="formulario" action = "" method = "POST">
                        ...
                        <table class = "tbl-30">
                            <tr>
                                <td>Senha Atual</td>
                                <td><input type="password" name="senha_atual" placeholder = "Senha Antiga"> </td>
                            </tr>
                ...
                <?php
                    ...
                    {                             
                        ...
                        $sql = "SELECT * FROM tabela_admin WHERE
                                id = '$id' and senha = '$senha_atual'";
                        ...
                        if($res == true)
                        {
                            ...
                            {
                                $_SESSION['user-not-found'] = "<div class = 'error'>Administrador não Encontrado</div>";
